...
export default function MusicPlayer() {
  ...
  const handlePause = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 w-full  z-10  bg-gray-950 text-white  ">
            ...
            <div className='flex flex-row justify-center -mt-6 mb-5 '>
              <Shuffle size={18}/>
              <SkipBack size={20} className='mr-5 ml-5'/>
              <div> <button onClick={handlePause}>{pause ? <Play size={20} color='green'/> : <Pause size={20} color='green'/>}</button></div>
