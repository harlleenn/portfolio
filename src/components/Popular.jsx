...
export default function Popular() {
  ...
  return (
    <div className=' absolute bg-gradient-to-r from-green-950 to-blue-300  p-4 left-64 mt-11  top-64  text-white'>
      <div className='flex flex-col space-y-5'>
        ...
        <div className='grid grid-cols-4 gap-2 items-center hover:bg-gradient-to-r from-green-900 to-blue-300 '>
      ...
      <div className='mt-10 mb-10'>
        ...
        <div className="grid md:grid-cols-5 gap-2">
         <div className="  bg-black border  rounded-lg shadow-sm p-4">
            ...
            <div className='rounded-3xl p-4 float-right bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 '>
